...
/* at Wed Mar 25 12:20:47 +0000 2009 */
...
namespace aug {
    ...
    class blob {
        ...
        static const char*
        gettype_(aug_blob* this_) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->getblobtype_();
        }
        static const void*
...
namespace aug {
    ...
    inline const char*
    getblobtype(aug::obref<aug_blob> this_) AUG_NOTHROW
    {
    ...
    public:
        ...
        {
            return this->impl_.getblobtype_();
        }
        const void*
