...
/* at Tue Aug 19 18:41:35 GMT Daylight Time 2008 */
...
namespace aug {
    ...
    inline aug_result
    getiterkey(aug::obref<aug_iter> this_, struct aug_var& var) AUG_NOTHROW
    {
        return this_.get()->vtbl_->getkey_(this_.get(), &var);
    }

    inline aug_result
    getitervalue(aug::obref<aug_iter> this_, struct aug_var& var) AUG_NOTHROW
    {
        return this_.get()->vtbl_->getvalue_(this_.get(), &var);
    }
