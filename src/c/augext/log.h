...
/* at Thu Feb 25 20:18:56 +0000 2010 */
...
struct aug_logvtbl {
    AUG_VTBL(aug_log);
    aug_result (*vwrite_)(aug_log*, unsigned, const char*, va_list);
};
...
namespace aug {
    ...
    class log {
        ...
        static aug_result
        vwrite_(aug_log* this_, unsigned level, const char* format, va_list args) AUG_NOTHROW
        {
...
namespace aug {
    ...
    inline aug_result
    vwritelog(aug::obref<aug_log> this_, unsigned level, const char* format, va_list args)
    {
        return verify(this_.get()->vtbl_->vwrite_(this_.get(), level, format, args));
    }
    ...
    public:
        ...
        aug_result
        vwritelog_(unsigned level, const char* format, va_list args) AUG_NOTHROW
        {
