...
struct aug_clockvtbl {
    AUG_VTBL(aug_clock);
    aug_result (*gettimeofday_)(aug_clock*, struct timeval*);
...
namespace aug {
    ...
    inline aug_result
    gettimeofday(aug::obref<aug_clock> this_, struct timeval& tv)
    {
        return verify(this_.get()->vtbl_->gettimeofday_(this_.get(), &tv), this_);
    }
