...
/* at Tue Mar 30 21:18:46 +0100 2010 */
...
struct aug_marvtbl {
    ...
    aug_rint (*clear_AIN_)(aug_mar*);
    aug_result (*deln_AIN_)(aug_mar*, unsigned);
    aug_rint (*delp_AIN_)(aug_mar*, const char*);
    ...
    aug_result (*putn_AIN_)(aug_mar*, unsigned, const void*, unsigned);
    aug_rint (*putp_AIN_)(aug_mar*, const char*, const void*, unsigned);
    aug_rint (*put_AIN_)(aug_mar*, const struct aug_field*);
    aug_result (*ntop_)(aug_mar*, unsigned, const char**);
    aug_rint (*pton_)(aug_mar*, const char*);
    unsigned (*getcount_)(aug_mar*);
    aug_result (*insert_AIN_)(aug_mar*, const char*);
    aug_rsize (*seek_)(aug_mar*, off_t, int);
    aug_result (*setcontent_AIN_)(aug_mar*, const void*, unsigned);
    aug_result (*sync_)(aug_mar*);
    aug_result (*truncate_AIN_)(aug_mar*, unsigned);
    aug_rsize (*write_AIN_)(aug_mar*, const void*, unsigned);
    aug_result (*extract_AIN_)(aug_mar*, const char*);
...
#define aug_clearfields_AIN(this_) \
    (this_)->vtbl_->clear_AIN_(this_)
...
#define aug_delfieldn_AIN(this_, n) \
    (this_)->vtbl_->deln_AIN_(this_, n)
...
#define aug_delfieldp_AIN(this_, name) \
    (this_)->vtbl_->delp_AIN_(this_, name)
...
#define aug_putfieldn_AIN(this_, n, value, size) \
    (this_)->vtbl_->putn_AIN_(this_, n, value, size)
...
#define aug_putfieldp_AIN(this_, name, value, size) \
    (this_)->vtbl_->putp_AIN_(this_, name, value, size)
...
#define aug_putfield_AIN(this_, field) \
    (this_)->vtbl_->put_AIN_(this_, field)
...
#define aug_insertmar_AIN(this_, path) \
    (this_)->vtbl_->insert_AIN_(this_, path)
...
#define aug_setcontent_AIN(this_, cdata, size) \
    (this_)->vtbl_->setcontent_AIN_(this_, cdata, size)
...
#define aug_truncatemar_AIN(this_, size) \
    (this_)->vtbl_->truncate_AIN_(this_, size)
...
#define aug_writemar_AIN(this_, buf, len) \
    (this_)->vtbl_->write_AIN_(this_, buf, len)
...
#define aug_extractmar_AIN(this_, path) \
    (this_)->vtbl_->extract_AIN_(this_, path)
...
namespace aug {
    ...
    class mar {
        ...
        static aug_rint
        clear_AIN_(aug_mar* this_) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->clearfields_AIN_();
        }
        static aug_result
        deln_AIN_(aug_mar* this_, unsigned n) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->delfieldn_AIN_(n);
        }
        static aug_rint
        delp_AIN_(aug_mar* this_, const char* name) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->delfieldp_AIN_(name);
        }
        static aug_rint
        ...
        static aug_result
        putn_AIN_(aug_mar* this_, unsigned n, const void* value, unsigned size) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->putfieldn_AIN_(n, value, size);
        }
        static aug_rint
        putp_AIN_(aug_mar* this_, const char* name, const void* value, unsigned size) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->putfieldp_AIN_(name, value, size);
        }
        static aug_rint
        put_AIN_(aug_mar* this_, const struct aug_field* field) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->putfield_AIN_(*field);
        }
        static aug_result
        ...
        static aug_result
        insert_AIN_(aug_mar* this_, const char* path) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->insertmar_AIN_(path);
        }
        static aug_rsize
        ...
        static aug_result
        setcontent_AIN_(aug_mar* this_, const void* cdata, unsigned size) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->setcontent_AIN_(cdata, size);
        }
        static aug_result
        ...
        static aug_result
        truncate_AIN_(aug_mar* this_, unsigned size) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->truncatemar_AIN_(size);
        }
        static aug_rsize
        write_AIN_(aug_mar* this_, const void* buf, unsigned len) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->writemar_AIN_(buf, len);
        }
        static aug_result
        extract_AIN_(aug_mar* this_, const char* path) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->extractmar_AIN_(path);
        }
        static aug_rsize
...
namespace aug {
    ...
    inline aug_rint
    clearfields_AIN(aug::obref<aug_mar> this_)
    {
        return verify(this_.get()->vtbl_->clear_AIN_(this_.get()));
    }

    inline aug_result
    delfieldn_AIN(aug::obref<aug_mar> this_, unsigned n)
    {
        return verify(this_.get()->vtbl_->deln_AIN_(this_.get(), n));
    }

    inline aug_rint
    delfieldp_AIN(aug::obref<aug_mar> this_, const char* name)
    {
        return verify(this_.get()->vtbl_->delp_AIN_(this_.get(), name));
    }
    ...
    inline aug_result
    putfieldn_AIN(aug::obref<aug_mar> this_, unsigned n, const void* value, unsigned size)
    {
        return verify(this_.get()->vtbl_->putn_AIN_(this_.get(), n, value, size));
    }

    inline aug_rint
    putfieldp_AIN(aug::obref<aug_mar> this_, const char* name, const void* value, unsigned size)
    {
        return verify(this_.get()->vtbl_->putp_AIN_(this_.get(), name, value, size));
    }

    inline aug_rint
    putfield_AIN(aug::obref<aug_mar> this_, const struct aug_field& field)
    {
        return verify(this_.get()->vtbl_->put_AIN_(this_.get(), &field));
    }
    ...
    inline aug_result
    insertmar_AIN(aug::obref<aug_mar> this_, const char* path)
    {
        return verify(this_.get()->vtbl_->insert_AIN_(this_.get(), path));
    }
    ...
    inline aug_result
    setcontent_AIN(aug::obref<aug_mar> this_, const void* cdata, unsigned size)
    {
        return verify(this_.get()->vtbl_->setcontent_AIN_(this_.get(), cdata, size));
    }
    ...
    inline aug_result
    truncatemar_AIN(aug::obref<aug_mar> this_, unsigned size)
    {
        return verify(this_.get()->vtbl_->truncate_AIN_(this_.get(), size));
    }

    inline aug_rsize
    writemar_AIN(aug::obref<aug_mar> this_, const void* buf, unsigned len)
    {
        return verify(this_.get()->vtbl_->write_AIN_(this_.get(), buf, len));
    }

    inline aug_result
    extractmar_AIN(aug::obref<aug_mar> this_, const char* path)
    {
        return verify(this_.get()->vtbl_->extract_AIN_(this_.get(), path));
    }
    ...
    public:
        ...
        aug_rint
        clearfields_AIN_() AUG_NOTHROW
        {
            return this->impl_.clearfields_AIN_();
        }
        aug_result
        delfieldn_AIN_(unsigned n) AUG_NOTHROW
        {
            return this->impl_.delfieldn_AIN_(n);
        }
        aug_rint
        delfieldp_AIN_(const char* name) AUG_NOTHROW
        {
            return this->impl_.delfieldp_AIN_(name);
        }
        aug_rint
        ...
        aug_result
        putfieldn_AIN_(unsigned n, const void* value, unsigned size) AUG_NOTHROW
        {
            return this->impl_.putfieldn_AIN_(n, value, size);
        }
        aug_rint
        putfieldp_AIN_(const char* name, const void* value, unsigned size) AUG_NOTHROW
        {
            return this->impl_.putfieldp_AIN_(name, value, size);
        }
        aug_rint
        putfield_AIN_(const struct aug_field& field) AUG_NOTHROW
        {
            return this->impl_.putfield_AIN_(field);
        }
        aug_result
        ...
        aug_result
        insertmar_AIN_(const char* path) AUG_NOTHROW
        {
            return this->impl_.insertmar_AIN_(path);
        }
        aug_rsize
        ...
        aug_result
        setcontent_AIN_(const void* cdata, unsigned size) AUG_NOTHROW
        {
            return this->impl_.setcontent_AIN_(cdata, size);
        }
        aug_result
        ...
        aug_result
        truncatemar_AIN_(unsigned size) AUG_NOTHROW
        {
            return this->impl_.truncatemar_AIN_(size);
        }
        aug_rsize
        writemar_AIN_(const void* buf, unsigned len) AUG_NOTHROW
        {
            return this->impl_.writemar_AIN_(buf, len);
        }
        aug_result
        extractmar_AIN_(const char* path) AUG_NOTHROW
        {
            return this->impl_.extractmar_AIN_(path);
        }
        aug_rsize
