...
/* at Wed Feb 24 21:08:06 +0000 2010 */
...
namespace aug {
    ...
    {
        verify(this_.get()->vtbl_->compact_(this_.get()));
    }

    inline unsigned
    clearfields(aug::obref<aug_mar> this_)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->clear_(this_.get()))));
    }

    inline void
    delfieldn(aug::obref<aug_mar> this_, unsigned n)
    {
        verify(this_.get()->vtbl_->deln_(this_.get(), n));
    }

    inline unsigned
    delfieldp(aug::obref<aug_mar> this_, const char* name)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->delp_(this_.get(), name))));
    }

    inline unsigned
    getfieldn(aug::obref<aug_mar> this_, unsigned n, const void*& value)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->getn_(this_.get(), n, &value))));
    }

    inline unsigned
    getfieldp(aug::obref<aug_mar> this_, const char* name, const void*& value)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->getp_(this_.get(), name, &value))));
    }

    inline void
    getfield(aug::obref<aug_mar> this_, unsigned n, struct aug_field& field)
    {
        verify(this_.get()->vtbl_->get_(this_.get(), n, &field));
    }

    inline void
    putfieldn(aug::obref<aug_mar> this_, unsigned n, const void* value, unsigned size)
    {
        verify(this_.get()->vtbl_->putn_(this_.get(), n, value, size));
    }

    inline unsigned
    putfieldp(aug::obref<aug_mar> this_, const char* name, const void* value, unsigned size)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->putp_(this_.get(), name, value, size))));
    }

    inline unsigned
    putfield(aug::obref<aug_mar> this_, const struct aug_field& field)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->put_(this_.get(), &field))));
    }

    inline void
    fieldntop(aug::obref<aug_mar> this_, unsigned n, const char*& name)
    {
        verify(this_.get()->vtbl_->ntop_(this_.get(), n, &name));
    }

    inline unsigned
    fieldpton(aug::obref<aug_mar> this_, const char* name)
    {
        return static_cast<unsigned>(AUG_RESULT(verify(this_.get()->vtbl_->pton_(this_.get(), name))));
    }
    ...
    {
        verify(this_.get()->vtbl_->insert_(this_.get(), path));
    }

    inline size_t
    seekmar(aug::obref<aug_mar> this_, off_t offset, int whence)
    {
        return static_cast<size_t>(AUG_RESULT(verify(this_.get()->vtbl_->seek_(this_.get(), offset, whence))));
    }

    inline void
    setcontent(aug::obref<aug_mar> this_, const void* cdata, unsigned size)
    {
        verify(this_.get()->vtbl_->setcontent_(this_.get(), cdata, size));
    }

    inline void
    syncmar(aug::obref<aug_mar> this_)
    {
        verify(this_.get()->vtbl_->sync_(this_.get()));
    }

    inline void
    truncatemar(aug::obref<aug_mar> this_, unsigned size)
    {
        verify(this_.get()->vtbl_->truncate_(this_.get(), size));
    }

    inline size_t
    writemar(aug::obref<aug_mar> this_, const void* buf, unsigned len)
    {
        return static_cast<size_t>(AUG_RESULT(verify(this_.get()->vtbl_->write_(this_.get(), buf, len))));
    }

    inline void
    extractmar(aug::obref<aug_mar> this_, const char* path)
    {
        verify(this_.get()->vtbl_->extract_(this_.get(), path));
    }

    inline size_t
    readmar(aug::obref<aug_mar> this_, void* buf, unsigned len)
    {
        return static_cast<size_t>(AUG_RESULT(verify(this_.get()->vtbl_->read_(this_.get(), buf, len))));
    }
...
namespace aug {
    ...
    {
        verify(this_.get()->vtbl_->del_(this_.get(), request));
    }
    ...
    {
        verify(this_.get()->vtbl_->put_(this_.get(), request, mar));
    }
