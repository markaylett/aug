...
/* at Fri Feb 26 07:10:53 +0000 2010 */
...
namespace aug {
    ...
    {
        return verify(this_.get()->vtbl_->clear_(this_.get()));
    }

    inline aug_result
    delfieldn(aug::obref<aug_mar> this_, unsigned n)
    {
        return verify(this_.get()->vtbl_->deln_(this_.get(), n));
    }

    inline aug_rint
    delfieldp(aug::obref<aug_mar> this_, const char* name)
    {
        return verify(this_.get()->vtbl_->delp_(this_.get(), name));
    }
    ...
    {
        return verify(this_.get()->vtbl_->putn_(this_.get(), n, value, size));
    }

    inline aug_rint
    putfieldp(aug::obref<aug_mar> this_, const char* name, const void* value, unsigned size)
    {
        return verify(this_.get()->vtbl_->putp_(this_.get(), name, value, size));
    }

    inline aug_rint
    putfield(aug::obref<aug_mar> this_, const struct aug_field& field)
    {
        return verify(this_.get()->vtbl_->put_(this_.get(), &field));
    }
    ...
    {
        return verify(this_.get()->vtbl_->insert_(this_.get(), path));
    }
    ...
    {
        return verify(this_.get()->vtbl_->setcontent_(this_.get(), cdata, size));
    }
    ...
    {
        return verify(this_.get()->vtbl_->truncate_(this_.get(), size));
    }

    inline aug_rsize
    writemar(aug::obref<aug_mar> this_, const void* buf, unsigned len)
    {
        return verify(this_.get()->vtbl_->write_(this_.get(), buf, len));
    }

    inline aug_result
    extractmar(aug::obref<aug_mar> this_, const char* path)
    {
        return verify(this_.get()->vtbl_->extract_(this_.get(), path));
    }
