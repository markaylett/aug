...
/* at Wed Jun 04 08:23:02 GMT Daylight Time 2008 */
...
namespace aug {
    ...
    inline aug_result
    getseqvalue(aug::obref<aug_seq> this_, struct aug_var& value, const struct aug_var& key) AUG_NOTHROW
    {
        return this_.get()->vtbl_->getvalue_(this_.get(), &value, &key);
    }
