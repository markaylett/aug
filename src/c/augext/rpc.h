...
/* at Wed Jun 04 08:23:01 GMT Daylight Time 2008 */
...
namespace aug {
    ...
    {
        return aug::object_attach<aug_seqob>(this_.get()->vtbl_->getargs_(this_.get()));
    }
