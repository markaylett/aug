...
/* at Sun Apr 04 22:17:11 +0100 2010 */
...
struct aug_chanvtbl {
    ...
    aug_chan* (*process_BI_)(aug_chan*, aug_chandler*, aug_bool*);
...
#define aug_processchan_BI(this_, handler, fork) \
    (this_)->vtbl_->process_BI_(this_, handler, fork)
...
namespace aug {
    ...
    class chan {
        ...
        static aug_chan*
        process_BI_(aug_chan* this_, aug_chandler* handler, aug_bool* fork) AUG_NOTHROW
        {
            return aug::retget(static_cast<T*>(this_->impl_)->processchan_BI_(handler, *fork));
        }
        static aug_result
...
namespace aug {
    ...
    processchan_BI(aug::obref<aug_chan> this_, aug::obref<aug_chandler> handler, aug_bool& fork)
    {
        return aug::object_attach<aug_chan>(verify(this_.get()->vtbl_->process_BI_(this_.get(), handler.get(), &fork)));
    }
    ...
    public:
        ...
        processchan_BI_(aug::obref<aug_chandler> handler, aug_bool& fork) AUG_NOTHROW
        {
            return this->impl_.processchan_BI_(handler, fork);
        }
        aug_result
