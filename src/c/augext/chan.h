...
/* at Fri Oct 03 20:12:26 GMT Daylight Time 2008 */
...
struct aug_chandlervtbl {
    ...
    void (*error_)(aug_chandler*, unsigned, const struct aug_errinfo*);
...
#define aug_errorchan(this_, id, errinfo) \
    (this_)->vtbl_->error_(this_, id, errinfo)
...
namespace aug {
    ...
    inline void
    errorchan(aug::obref<aug_chandler> this_, unsigned id, const struct aug_errinfo& errinfo) AUG_NOTHROW
    {
        this_.get()->vtbl_->error_(this_.get(), id, &errinfo);
    }
    ...
    class chandler {
        ...
        static void
        error_(aug_chandler* this_, unsigned id, const struct aug_errinfo* errinfo) AUG_NOTHROW
        {
            static_cast<T*>(this_->impl_)->errorchan_(id, *errinfo);
        }
        static aug_bool
    ...
    public:
        ...
        void
        errorchan_(unsigned id, const struct aug_errinfo& errinfo) AUG_NOTHROW
        {
            this->impl_.errorchan_(id, errinfo);
        }
        aug_bool
...
struct aug_chanvtbl {
    ...
    unsigned short (*getmask_)(aug_chan*);
    unsigned (*getid_)(aug_chan*);
    char* (*getname_)(aug_chan*, char*, unsigned);
    aug_bool (*isblocked_)(aug_chan*);
};
...
#define aug_isblocked(this_) \
    (this_)->vtbl_->isblocked_(this_)
...
namespace aug {
    ...
    {
        verify(this_.get()->vtbl_->setmask_(this_.get(), mask), this_);
    }
    ...
    inline aug_bool
    isblocked(aug::obref<aug_chan> this_) AUG_NOTHROW
    {
        return this_.get()->vtbl_->isblocked_(this_.get());
    }
    ...
    class chan {
        ...
        static aug_bool
        isblocked_(aug_chan* this_) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->isblocked_();
        }
    ...
    public:
        ...
        aug_bool
        isblocked_() AUG_NOTHROW
        {
            return this->impl_.isblocked_();
        }
