...
/* at Sun Nov 16 10:36:44 GMT Standard Time 2008 */
...
struct aug_httphandlervtbl {
    ...
    aug_result (*initial_)(aug_httphandler*, const char*);
...
#define aug_httpinitial(this_, value) \
    (this_)->vtbl_->initial_(this_, value)
...
namespace aug {
    ...
    class httphandler {
        ...
        static aug_result
        initial_(aug_httphandler* this_, const char* value) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->httpinitial_(value);
        }
        static aug_result
...
namespace aug {
    ...
    inline void
    httpinitial(aug::obref<aug_httphandler> this_, const char* value)
    {
        verify(this_.get()->vtbl_->initial_(this_.get(), value), this_);
    }

    inline void
    httpfield(aug::obref<aug_httphandler> this_, const char* name, const char* value)
    {
        verify(this_.get()->vtbl_->field_(this_.get(), name, value), this_);
    }

    inline void
    httpcsize(aug::obref<aug_httphandler> this_, unsigned size)
    {
        verify(this_.get()->vtbl_->csize_(this_.get(), size), this_);
    }

    inline void
    httpcdata(aug::obref<aug_httphandler> this_, const void* buf, unsigned len)
    {
        verify(this_.get()->vtbl_->cdata_(this_.get(), buf, len), this_);
    }

    inline void
    httpend(aug::obref<aug_httphandler> this_, aug_bool commit)
    {
        verify(this_.get()->vtbl_->end_(this_.get(), commit), this_);
    }
    ...
    public:
        ...
        {
            return this->impl_.httpinitial_(value);
        }
        aug_result
