...
/* at Tue Apr 22 07:10:33 GMT Daylight Time 2008 */
...
#define aug_getmd(this_) \
    (this_)->vtbl_->getmd_(this_)
...
namespace aug {
    ...
    inline aug_md
    getmd(aug::obref<aug_file> this_) AUG_NOTHROW
    {
        return this_.get()->vtbl_->getmd_(this_.get());
    }
    ...
    class file {
        ...
        static aug_md
        getmd_(aug_file* this_) AUG_NOTHROW
        {
            return static_cast<T*>(this_->impl_)->getmd_();
        }
