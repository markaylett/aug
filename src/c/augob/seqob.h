...
/* at Thu May 15 18:55:08 GMT Daylight Time 2008 */
...
struct aug_seqobvtbl {
    AUG_VTBL(aug_seqob);
    aug_result (*find_)(aug_seqob*, struct aug_var*, const struct aug_var*);
...
namespace aug {
    ...
    class seqob {
        ...
        {
            return aug::retget(static_cast<T*>(this_->impl_)->seqobbegin_());
        }
        static int
