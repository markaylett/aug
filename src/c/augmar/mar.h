 ...
 *
 * \return zero on success or -1 on failure, in which case #aug_errno can be
 ...
 * in which case #aug_errno can be used to determine the error.
 *
...
/**
 * \brief Compact any used spaceg within message archive.
 *
 * \param mar A handle to the message archive.
 *
 * \return zero on success or -1 on failure, in which case #aug_errno can be
 ...
 * on failure, in which case #aug_errno can be used to determine the error.
 *
 ...
 * #aug_errno can be used to determine the error.
 *
 ...
 * content, or -1 on failure, in which case #aug_errno can be used to
 * determine the error.
 *
 ...
 * case #aug_errno can be used to determine the error.
 *
 ...
 * content is set.
 *
 * \return A pointer to the content or NULL on failure, in which case
 * #aug_errno can be used to determine the error.
 *
 ...
 * -1 is returned on failure, in which case #aug_errno can be used to
 * determine the error.
 *
 ...
 * \param mar A handle to the message archive.
 *
 * \param size The output parameter, in which, the size of the content will
 * be returned.
 *
 * \return zero on success or -1 on failure, in which case #aug_errno can be
 * used to determine the error.
