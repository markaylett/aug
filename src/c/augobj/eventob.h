...
/* at Tue Dec 04 07:12:47 GMT Standard Time 2007 */
...
namespace aug {
    ...
    inline void
    seteventobuser(aug::obref<aug_eventob> this_, aug_object* user) AUG_NOTHROW
    {
        this_.get()->vtbl_->setuser_(this_.get(), user);
    }
    ...
    public:
        ...
        operator aug::obref<aug_eventob>()
        {
            return this->get();
        }
    };
    ...
    public:
        ...
        cast_(const char* id) AUG_NOTHROW
        {
            if (aug::equalid<aug_object>(id) || aug::equalid<aug_eventob>(id))
                return aug::object_attach<aug_object>(this->eventob_);
            return null;
        }
        int
        incref_() AUG_NOTHROW
        ...
        void
        seteventobuser_(aug_object* user) AUG_NOTHROW
        {
