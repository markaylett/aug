...
*/
#ifndef AUGARCPP_WILD_HPP
#define AUGARCPP_WILD_HPP

#include "augarcpp/factory.hpp"
#include "augarcpp/inverse.hpp"
...
namespace aug {
    ...
    public:
        ...
        explicit
        wild(const factory_base& factory)
            : match_(ARCNOTHING),
              wildchild_(factory.createinner()),
              exnames_(factory)
        {
        }
    };
